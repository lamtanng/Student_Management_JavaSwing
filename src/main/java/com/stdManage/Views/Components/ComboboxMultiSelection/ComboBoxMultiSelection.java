//package com.stdManage.Views.Components.ComboboxMultiSelection;
//
...
//            JButton cmd = new JButton(new FlatSVGIcon(U_Common.RESOURCE.concat(U_Common.IMAGE_FOLDER).concat("trash-xmark.png"), 0.6f));
