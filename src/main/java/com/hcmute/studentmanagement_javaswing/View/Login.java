 ...
 */
package com.hcmute.studentmanagement_javaswing.View;

import com.hcmute.studentmanagement_javaswing.View.Components.Hint_JTextField;
...
public class Login extends javax.swing.JFrame {
    ...
    public void initTextField(){
        Hint_JTextField jTextHint = new Hint_JTextField("UserName");
        jTextHint.setSize(200, 50);
        jTextHint.setName("jTxt_UserName");
        jTextHint.paint(getGraphics());
        jPanel_Login.add(jTextHint);
    }
